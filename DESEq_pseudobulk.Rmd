...
source.output.dir <- file.path(paste0(folder, "/output_DE"))
...
group_assignment <- read_csv2(paste0(folder, "/output_cnv/CNV_metrics_CIN_assignment.csv"))
...
if(export){
sc_means %>% write_csv2(file = paste0(source.output.dir, "/sc_means.csv"))
}
...
# Export
df.deseq.pseudobulkWald %>% write.csv2(paste0(source.output.dir, "/df.deseq.results.pseudobulkWald.csv"), row.names = FALSE)
 
df.deseq.pseudobulkWald.apeglm %>% write.csv2(paste0(source.output.dir, "/df.deseq.results.pseudobulkWald.apeglm.csv"), row.names = FALSE)
...
# Export
df.deseq.pseudobulk.Waldscore %>% write.csv2(paste0(source.output.dir, "/df.deseq.results.pseudobulkWaldscore.csv"), row.names = FALSE)

df.deseq.pseudobulk.Waldscore.apeglm %>% write.csv2(paste0(source.output.dir, "/df.deseq.results.pseudobulkWaldscore.apeglm.csv"), row.names = FALSE)
```
...
if(export){
  ggsave(file=paste0(source.output.dir,"/deseq2Wald_pseudobulk_volcano.png"), width=6, height=4, dpi=300)
}
...
if(export){
  ggsave(file=paste0(source.output.dir,"/deseq2Waldapeglm_pseudobulk_volcano.png"), width=6, height=4, dpi=300)
}
```
...
if(export){
  ggsave(file=paste0(source.output.dir,"/deseq2Waldscore_pseudobulk_volcano.png"), width=6, height=4, dpi=300)
}
...
# fgseaRes.deseqstat <- read.csv2(file = paste0(source.output.dir, "/scRNA_fgsea_CIN_highlow.csv"))
...
if (export){
ggsave(file = paste0(source.output.dir, "/fGSEA_pseudobulk_deseq.png"), width=8, height=5, dpi=300)
}

if(export){
  fgseaRes.deseq %>% select(-leadingEdge) %>% write.csv2(file = paste0(source.output.dir, "/pseudobulk_fgsea_deseq.csv"), row.names = FALSE)

  leading_edge_df %>% write.csv2(file = paste0(source.output.dir, "/pseudobulk_fgsea_deseq_leadingedge.csv"), row.names = FALSE)
  }
```
...
if (export){
ggsave(file = paste0(source.output.dir, "/fGSEA_pseudobulk_deseqstat.png"), width=8, height=5, dpi=300)
}

if(export){
  fgseaRes.deseqstat %>% select(-leadingEdge) %>% write.csv2(file = paste0(source.output.dir, "/pseudobulk_fgsea_deseqstat.csv"), row.names = FALSE)

  leading_edge_df %>% write.csv2(file = paste0(source.output.dir, "/pseudobulk_fgsea_deseqstat_leadingedge.csv"), row.names = FALSE)
  }
```
...
if (export){
ggsave(file = paste0(source.output.dir, "/fGSEA_pseudobulk_scoredeseqstat.png"), width=8, height=5, dpi=300)
}

if(export){
  fgseaRes.scoredeseqstat %>% select(-leadingEdge) %>% write.csv2(file = paste0(source.output.dir, "/pseudobulk_fgsea_scoredeseqstat.csv"), row.names = FALSE)

  leading_edge_df %>% write.csv2(file = paste0(source.output.dir, "/pseudobulk_fgsea_scoredeseqstat_leadingedge.csv"), row.names = FALSE)
  }
```
