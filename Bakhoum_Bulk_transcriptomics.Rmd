...
# GSEA_res <- GSEA_res %>% mutate(cropped_name = sub("HALLMARK_", "", NAME)
GSEA_res_names <- GSEA_res %>% filter(within_threshold) 
GSEA_res_names$cropped_name = c("Kras signaling", "Angiogenesis", "Androgen response", "Inflammatory response", "Wnt/B-catenin", "EMT", "OxPhos", "ROS", "Myc targets v2", "Apical Surface")  
