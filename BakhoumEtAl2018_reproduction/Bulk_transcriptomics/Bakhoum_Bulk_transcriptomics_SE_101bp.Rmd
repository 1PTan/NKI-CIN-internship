...
# fgseaRes <- read.csv2("output/bulk_fgsea_shrunkfc_CIN_highlow.csv")
```
...
# fgseaRes.noLFC <- read.csv2("output/bulk_fgsea_notshrunkfc_CIN_highlow.csv")
```
...
# fgseaRes.noLFC.stat <- read.csv2("output/bulk_fgsea_Zstat_CIN_highlow.csv")
```
...
if(export){
  ggsave(file = paste0(source.output.dir,"/notshrunk_fGSEA_x_orig.png")
