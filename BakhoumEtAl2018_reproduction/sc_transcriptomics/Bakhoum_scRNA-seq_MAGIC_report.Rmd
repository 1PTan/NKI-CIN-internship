...
```{r}
# Load objects instead of handling computations in this script
...
knitr::include_graphics(paste(source.output.dir, "EMT_heatmap.png", sep="/"))
knitr::include_graphics(paste(source.output.dir, "EMT_heatmap_trim.png", sep="/"))
...
lapply(seq_along(cluster.DE.fgsea), FUN = function(i){
  cluster.DE.fgsea[[i]] <- cluster.DE.fgsea[[i]] %>% mutate(
    ...
    padj = ifelse(pval < 0.0001, 0.000101, padj)
...
if(export){
save_pheatmap_png(cluster_NES, filename = paste0(source.output.dir, "/magic_cluster_NES_heatmap.png"), width = 500, height = 500)
}
