...
```{r}
plot_cluster_split_violin(object = scRNA_regcycle, id1 = 3, id2 = 1, gene_list = M_markers)
```
...
cellreg.cluster.DE.fgsea_summary <- read.csv2(file = paste0(source.output.dir, "/scRNA_cellreg_clusters_fgsea1.csv"))
cellreg.cluster.DE.fgsea <- cellreg.cluster.DE.fgsea_summary %>% split(f = cellreg.cluster.DE.fgsea_summary$cluster)
...
cellreg.cluster.DE.fgsea.gampoi <- cellreg.cluster.DE.fgsea.gampoi_summary %>% split(f = cellreg.cluster.DE.fgsea.gampoi_summary$cluster)
...
cellreg.cluster.DE.fgsea.gampoi_summary %>% mutate(NES = ifelse(padj < 0.2, NES, 0)) %>% left_join(msigdb_hallmarks_names) %>% select(name, NES, cluster) %>% pivot_wider(values_from = NES, names_from = name) %>% column_to_rownames("cluster") %>% mutate_all(~replace(., is.na(.), 0)) %>% as.matrix() %>% pheatmap(col=colfunc(11))
...
# cellreg.cluster.DE13 %>% write.csv2(file = paste0(source.output.dir, "/scRNA_cellreg_cluster13.csv"), row.names = FALSE)
# cellreg.cluster.DE13 <- read.csv2(file = paste0(source.output.dir, "/scRNA_cellreg_cluster13.csv"))
# 
...
# cellreg.cluster.DE04 %>% write.csv2(file = paste0(source.output.dir, "/scRNA_cellreg_cluster04.csv"), row.names = FALSE)
# cellreg.cluster.DE04 <- read.csv2(file = paste0(source.output.dir, "/scRNA_cellreg_cluster04.csv"))
# 
...
# cellreg.cluster.DE56 %>% write.csv2(file = paste0(source.output.dir, "/scRNA_cellreg_cluster56.csv"), row.names = FALSE)
# cellreg.cluster.DE56 <- read.csv2(file = paste0(source.output.dir, "/scRNA_cellreg_cluster56.csv"))
# 
...
# cellreg.cluster.DE52 %>% write.csv2(file = paste0(source.output.dir, "/scRNA_cellreg_cluster52.csv"), row.names = FALSE)
# cellreg.cluster.DE52 <- read.csv2(file = paste0(source.output.dir, "/scRNA_cellreg_cluster52.csv"))
# 
...
# cellreg.cluster.DE62 %>% write.csv2(file = paste0(source.output.dir, "/scRNA_cellreg_cluster62.csv"), row.names = FALSE)
# cellreg.cluster.DE62 <- read.csv2(file = paste0(source.output.dir, "/scRNA_cellreg_cluster62.csv"))
# 
# 
...
# cellreg.cluster.DE10 %>% write.csv2(file = paste0(source.output.dir, "/scRNA_cellreg_cluster10.csv"), row.names = FALSE)
# cellreg.cluster.DE10 <- read.csv2(file = paste0(source.output.dir, "/scRNA_cellreg_cluster10.csv"))
# 
# 
...
# cellreg.cluster.DE14 %>% write.csv2(file = paste0(source.output.dir, "/scRNA_cellreg_cluster14.csv"), row.names = FALSE)
# cellreg.cluster.DE14 <- read.csv2(file = paste0(source.output.dir, "/scRNA_cellreg_cluster14.csv"))
# 
# 
...
# cellreg.cluster.DE30 %>% write.csv2(file = paste0(source.output.dir, "/scRNA_cellreg_cluster30.csv"), row.names = FALSE)
# cellreg.cluster.DE30 <- read.csv2(file = paste0(source.output.dir, "/scRNA_cellreg_cluster30.csv"))
# 
...
# cellreg.cluster.DE34 %>% write.csv2(file = paste0(source.output.dir, "/scRNA_cellreg_cluster34.csv"), row.names = FALSE)
# cellreg.cluster.DE34 <- read.csv2(file = paste0(source.output.dir, "/scRNA_cellreg_cluster34.csv"))
# 
# 
...
if(export){
cellreg.specific.clusters.fgsea_summary %>% select(-leadingEdge) %>% write.csv2(file = paste0(source.output.dir, "/scRNA_cellreg_specific_cluster_fgsea.csv"), row.names = FALSE)
}
